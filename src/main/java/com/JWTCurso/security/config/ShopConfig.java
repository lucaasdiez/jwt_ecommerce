package com.JWTCurso.security.config;

import com.JWTCurso.security.jwt.AuthTokenFilter;
import com.JWTCurso.security.jwt.JwtAuthEntryPoint;
...
public class ShopConfig {
    private final ShopUsuarioDetalleService usuarioDetalleService;
    private final JwtAuthEntryPoint jwtAuthEntryPoint;

    private static final List<String> SERCURED_URL =
            List.of("/api/v1/carritos/**","/api/v1/carritoItems/**" );
